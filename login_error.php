...
<head>
  ...
  <link rel="stylesheet" href="lib/matrix-login.css" />
      ...
      <form class="form-login" method="POST" action="login/">
        ...
        <div class="login-wrap">
          ...
          <div class="registration">
            ...
            <a class="" href="masyarakat/index.php?page=daftar">
              Buat Akun
            </a>
          </div>
        </div>
  ...
  <script>
    $.backstretch("img/loginBg.jpg", {
      speed: 500
          ...
          <!-----ERROR WARNING ---->
<link rel="stylesheet" href="lib/jquery.gritter.css" />
...
<script src="lib/matrix.interface.js"></script> 
</body>
