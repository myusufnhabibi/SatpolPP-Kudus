      ...
      <section class="wrapper site-min-height">
        <?php 
          if (@$_GET['page'] == "" || @$_GET['page'] == "index") {
              include "aduan/beranda.php";
          } elseif(@$_GET['page'] == "aduan") {
              include "aduan/home.php";
          } elseif(@$_GET['page'] == "logOut") {
            $user->logOut();
            echo "<script>window.location='index.php'</script>"; 
          } elseif(@$_GET['page'] == "cek") {
            include "aduan/cek.php";
          } elseif(@$_GET['page'] == "lapor") {
            include "aduan/lapor.php";
          } elseif(@$_GET['page'] == "hasil") {
            include "aduan/hasil_laporan.php";
          } elseif(@$_GET['page'] == "detail") {
            include "aduan/detail.php";
          } elseif(@$_GET['page'] == "cetak") {
            include "aduan/cetak.php";
          }
        ?>
      </section>
      <!-- /wrapper -->
